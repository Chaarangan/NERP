...
class NERP:
    def __init__(self,
        ...
        self.is_model_exists = dictionary["model"]["is_model_exists"]
        self.existing_model_path = dictionary["model"]["existing_model_path"]
        self.existing_tokenizer_path = dictionary["model"]["existing_tokenizer_path"]
        self.output_dir = dictionary["model"]["output_dir"]
